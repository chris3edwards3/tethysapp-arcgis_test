    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.arcgis_test"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.arcgis_test.tests.tests"

        To run tests in the ArcgisTestTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.arcgis_test.tests.tests.ArcgisTestTestCase"

        To run only the test_if_tethys_platform_is_great function in the ArcgisTestTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.arcgis_test.tests.tests.ArcgisTestTestCase.test_if_tethys_platform_is_great"
...
class ArcgisTestTestCase(TethysTestCase):
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/arcgis-test/')  # The final '/' is essential for all pages/controllers
